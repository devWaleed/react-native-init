							...
							<View style={{ flexDirection: 'row', marginVertical: 10 }}>
								<TouchableOpacity
									...
									<View
										...
										<Text
											style={{
												color: headingTab === 'Cuisine' ? '#00d563' : 'black',
												fontWeight: 'bold',
												borderBottomColor: '#00d563',
												borderBottomWidth: headingTab === 'Cuisine' ? 4 : 0,
												paddingVertical: 10,
											}}>
											Cuisine
										</Text>
								...
								<TouchableOpacity
									...
									<View
										...
										<Text
											style={{
												color: headingTab === 'Attributes' ? '#00d563' : 'black',
												fontWeight: 'bold',
												borderBottomColor: '#00d563',
												borderBottomWidth: headingTab === 'Attributes' ? 4 : 0,
												paddingVertical: 10,
											}}>
											Attributes
										</Text>
								...
								<TouchableOpacity
									...
									<View
										...
										<Text
											style={{
												color: headingTab === 'Price' ? '#00d563' : 'black',
												fontWeight: 'bold',
												borderBottomColor: '#00d563',
												borderBottomWidth: headingTab === 'Price' ? 4 : 0,
												paddingVertical: 10,
											}}>
											Price
										</Text>
				...
				<View style={{ flex: 1, padding: 10, marginVertical: 10 }}>
					<View>
						...
						<ScrollView showsHorizontalScrollIndicator={false} horizontal={true} style={{ flexDirection: 'row' }}>
							<TouchableOpacity
								onPress={() => (searchTab === 'Payment' ? setSearchTab('') : setSearchTab('Payment'))}
								style={{
									backgroundColor: searchTab === 'Payment' ? '#00d563' : '#fff',
									padding: 5,
									borderRadius: 50,
									paddingHorizontal: 15,
									marginHorizontal: 5,
								}}>
								<Text style={{ color: searchTab === 'Payment' ? '#fff' : '#00d563', fontWeight: 'bold' }}>
									Payment Availble
								</Text>
							</TouchableOpacity>
							<TouchableOpacity
								onPress={() => (searchTab === 'Voucher' ? setSearchTab('') : setSearchTab('Voucher'))}
								style={{
									backgroundColor: searchTab === 'Voucher' ? '#00d563' : '#fff',
									padding: 5,
									borderRadius: 50,
									paddingHorizontal: 15,
									marginHorizontal: 5,
								}}>
								<Text style={{ color: searchTab === 'Voucher' ? '#fff' : '#00d563', fontWeight: 'bold' }}>
									Accept Vouchers
								</Text>
							</TouchableOpacity>
							<TouchableOpacity
								onPress={() => (searchTab === 'Deal' ? setSearchTab('') : setSearchTab('Deal'))}
								style={{
									backgroundColor: searchTab === 'Deal' ? '#00d563' : '#fff',
									padding: 5,
									borderRadius: 50,
									paddingHorizontal: 15,
									marginHorizontal: 5,
								}}>
								<Text style={{ color: searchTab === 'Deal' ? '#fff' : '#00d563', fontWeight: 'bold' }}>
									Deals
								</Text>
							</TouchableOpacity>
						</ScrollView>
			...
			<View style={{ justifyContent: 'space-between', flexDirection: 'row', padding: 10, marginTop: 10, marginBottom: 5 }}>
				...
				<View style={{ flex: 1, height: 40, justifyContent: 'center' }}>
					<TextInput
						...
						placeholder="Search"
						style={{ paddingHorizontal: 10, backgroundColor: '#eee', borderRadius: 10, color: 'black' }}
					/>
				</View>
			...
			<View style={{ flexDirection: 'row' }}>
				<View style={{ marginHorizontal: 10 }}>
					<TouchableOpacity
						...
						style={{
							backgroundColor: selectedTab === 'Delivery' ? '#00d563' : '#fff',
							padding: 5,
							borderRadius: 50,
							paddingHorizontal: 15,
						}}>
						<Text style={{ color: selectedTab === 'Delivery' ? '#fff' : '#00d563', fontWeight: 'bold' }}>
							Delivery
						</Text>
					</TouchableOpacity>
				</View>
				<View>
					<TouchableOpacity
						...
						style={{
							backgroundColor: selectedTab === 'Pickup' ? '#00d563' : '#fff',
							padding: 5,
							borderRadius: 50,
							paddingHorizontal: 15,
						}}>
